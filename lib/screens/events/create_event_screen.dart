...
class _AddEventScreenState extends ConsumerState<AddEventScreen> {
  ...
  // ✅ REPLACED SINGLE BANNER WITH LIST (for ImageCropPicker)
  List<XFile> banners = [];
  ...
  Future<void> submit() async {
    ...
    try {
      ...
      await api.uploadMultipart(
        ...
        files: [banners.first], // ✅ cropped banner
      ...
      body: Form(
        ...
        child: ListView(
          ...
          children: [
            ...
            AppTextField(label: "Venue", controller: venue),
            const SizedBox(height: AppSpacing.sm),
            ...
            Row(
              children: [
                ...
                Expanded(child: AppTextField(label: "City", controller: city)),
              ],
            ),
            ...
            Row(
              children: [
                Expanded(child: AppTextField(label: "Latitude", controller: latitude)),
                const SizedBox(width: 10),
                Expanded(child: AppTextField(label: "Longitude", controller: longitude)),
                const SizedBox(width: 10),
